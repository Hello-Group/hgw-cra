# HGW custom react-scripts
Adds ability to provide development dependencies to be installed as part of the create-react-app init flow.

### Publishing
Navigate to react-scripts folder
